...
namespace Moody.UI.Context
{
    public class ControlManager
    {
        ...
        public void Place(string containerName, string regionName, string elementName, params object[] parameter)
        {
            ...
            //ContentPresenter contentPresenter = VisualTreeHelper.GetChild(containerControl, 0) as ContentPresenter;
            ...
            // if (elementControl is IView)
            // {
            //    ((IView) elementControl).SetFocus();
            // }
        }
